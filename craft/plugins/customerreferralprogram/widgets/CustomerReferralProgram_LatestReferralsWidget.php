 ...
 *
 * CustomerReferralProgram_LatestReferrals Widget
 *
 * --snip--
 ...
 */
namespace Craft;
class CustomerReferralProgram_LatestReferralsWidget extends BaseWidget
{
    /**
    ...
    {
        return Craft::t('Customer Referral Program_LatestReferrals');
    }
    /**
    ...
    public function getBodyHtml()
    {
        ...
        craft()->templates->includeCssResource('customerreferralprogram/css/widgets/CustomerReferralProgram_LatestReferralsWidget.css');
        craft()->templates->includeJsResource('customerreferralprogram/js/widgets/CustomerReferralProgram_LatestReferralsWidget.js');
        /* -- Variables to pass down to our rendered template */
        $variables = array();
        $variables['settings'] = $this->getSettings();
        return craft()->templates->render('customerreferralprogram/widgets/CustomerReferralProgram_LatestReferralsWidget_Body', $variables);
    }
    /**
...
/* -- Variables to pass down to our rendered template */
        ...
        $variables = array();
        $variables['settings'] = $this->getSettings();
        return craft()->templates->render('customerreferralprogram/widgets/CustomerReferralProgram_LatestReferralsWidget_Settings',$variables);
    }
