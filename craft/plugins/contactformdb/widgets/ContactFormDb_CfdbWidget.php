 ...
 */
namespace Craft;
class ContactFormDb_CfdbWidget extends BaseWidget
{
    /**
    ...
    {
        return Craft::t('Contact Form DB_Cfdb');
    }
    /**
    ...
    public function getBodyHtml()
    {
        ...
        craft()->templates->includeCssResource('contactformdb/css/widgets/ContactFormDb_CfdbWidget.css');
        craft()->templates->includeJsResource('contactformdb/js/widgets/ContactFormDb_CfdbWidget.js');
        /* -- Variables to pass down to our rendered template */
        $variables = array();
        $variables['settings'] = $this->getSettings();
        return craft()->templates->render('contactformdb/widgets/ContactFormDb_CfdbWidget_Body', $variables);
    }
    /**
...
/* -- Variables to pass down to our rendered template */
        ...
        $variables = array();
        $variables['settings'] = $this->getSettings();
        return craft()->templates->render('contactformdb/widgets/ContactFormDb_CfdbWidget_Settings',$variables);
    }
